<template>
<div>
    <div class="jumbotron jumbotron-fluid header-desciption" style="background-image:url('/Image/MainPage/computer-4.jpg');color:blanchedalmond">
        <div class="container details">
            ...
            An online community isn’t built or befriended, it’s connected by offering and accepting.<strong> Community is affinity, identity, and kinship </strong> that make room for ideas, thoughts, and solutions. Wherever a community gathers, we aspire and inspire each other intentionally . . . And our words shine with authenticity. Many social networking sites also offer platforms for discussion of topics that a community or network finds mutually interesting or beneficial.
            In the most concise terms, an online social community is <strong> a group of like-minded individuals connected by interactions</strong>.</p>
        </div>
    </div>
                ...
                <div class="col-6">
                    <div class="post">
                        ...
                        <form @submit.prevent="AddArticle()">
                            <span class="user-photo"><img src="/Image/profile/avatar03.png" width="50px" height="50px"></span>
                            ...
                            <textarea name="body" class="form-control" style="margin-left:60px" placeholder="your body here.." v-model="form.body" :class="{ 'is-invalid': form.errors.has('body') }"></textarea>
                    ...
                    <hr>
                    <input type="search" name="search" v-model="search" placeholder="Search Articles By Titles" class="form-control">
                    <hr>    
                    ...
                    <div class="all-post">
                        <div class="post-item" v-for="article in filteredArticles" :key="article.id">
                            <router-link :to="'/community/article/'+article.id">
                                <span class="user-photo"><img src="/Image/profile/avatar03.png">&nbsp;&nbsp;{{article.users.name}} <br>
...
<script>
    export default {
        ...
        methods:{
            LoadArticles(){
                axios.get('/stud/articles/'+this.trackID)
                .then((data)=> {
                    this.articles = data.data
                })
            },
            LoadTracks(){
                axios.get('/stud/tracks')
                .then((data)=> {
                    this.tracks = data.data
                })
            },
            AddArticle(){
                this.form.post('/stud/post_article')
                .then(({data})=>{
                    swal.fire({
                        position: 'top-end',
                        type: 'success',
        ...
        created(){
            ...
            setInterval(()=>this.LoadArticles(),6000)
        }
    }
</script>
