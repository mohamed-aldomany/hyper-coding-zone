    ...
    <div>
        <div class="backgroung_gradiant">
            <div class="container details">
                <h1 class="text-center">Social Community</h1>
                <p class="lead">A community is a social structure that shares personal values, cultural values, business goals, attitudes, or a world view. What binds it is a community culture of social rules and group dynamics that identify members.
                An online community isn’t built or befriended</p>
            </div>
        </div>

        <div class="jumbotron jumbotron-fluid" style="position:relative;bottom:32px;margin-top:-20px">
            <div class="container">
                <div class="row">
                    <div class="col-md-5">
                        <h3 class="text-uppercase">Choose Filter</h3>
                    </div>
                    <div class="col-md-7">
                        <h3>
                            <router-link to="/community/articles/track/1" class="badge badge-pill badge-danger p-2">Web Design</router-link>
                            <router-link to="/community/articles/track/2" class="badge badge-pill badge-dark p-2">Web Developement</router-link>
                            <router-link to="/community/articles/track/3" class="badge badge-pill badge-danger p-2">Full Stack</router-link>
                            <router-link to="/community/articles/track/4" class="badge badge-pill badge-dark p-2">Mean Stack</router-link>
                        </h3>
                    </div>
                </div>
            </div>
        ...
        <section class="comunity">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-4">
                        <aside class="new-feed">
                            <ul class="list-group">
                                <li class="list-group-item">
                                    <div class="card">
                                        <img class="card-img-top" src="/Image/course/ajax.png" alt="Card image cap">
                                        <div class="card-body">
                                ...
                                <li class="list-group-item">privacy update</li>
                            </ul>
                        </aside>
                    </div>
                </div>
...
<script>
    export default {
        ...
        methods:{
            LoadArticles(){
                axios.get('/stud/community/articles')
                .then((data)=> {
            ...
            AddArticle(){
                this.form.post('/stud/community/post-article')
                .then(({data})=>{
                    swal.fire({
                        position: 'top-end',
                        type: 'success',
            ...
            ShowArticle(aid){
                this.$router.push({path: '/community/article/'+aid });
            },
            LoadArticleAutomatic(){
                this.test = setInterval(()=>this.LoadArticles(),3000)
            }
        },
        computed:{
            filteredArticles:function(){
                return this.articles.filter((article)=>{
                    return article.body.match(this.search)
                });
            },
        },
        beforeDestroy () {
        ...
        created(){
            ...
            this.LoadArticleAutomatic();
            axios.get('/stud/User/ActiveUser')
                .then((data)=> {
